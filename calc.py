...
class Calculator:
    ...
    def __createButtons(self):
        ...
        for (cx,cy,label) in bSpecs:
            ...
            self.buttons.append(Button(self.win, Point(4.5,2), 1.75, .75, "="))
    ...
    def getButton(self):
        # Waits for a button to be clicked and returns the lavel of
    ...
    def run(self):
        # Infinite even loop to process button clicks.
        while True:
            key = self.getButton()
